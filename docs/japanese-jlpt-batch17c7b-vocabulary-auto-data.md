...
第二輪逐項代入又撤換 N5 context 的「高校／小学校／鍵／電気」與 N4 context 的「気分」：原錯項仍可分別與「駅の近く」、「歩いて行く」、「なくす」、「つける」或「線がいい」形成合理語境。新題改為「椅子に座る」、「靴を脱ぐ」、「酒を飲む」、「雨が降る」及「背中が痛い」，並配置無法與各述語自然搭配的同級名詞。這是實際更換 target 與 options，而非僅重寫錯誤理由。
