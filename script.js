...
const JAPANESE_LISTENING_QUESTIONS = [
  ...
  { id: "jl-031", level: "N5", category: "日常生活", japanese: "朝、コーヒーを飲みます。", kana: "あさ、コーヒーを のみます。", zh: "早上喝咖啡。", question: "這句日文的意思是什麼？", options: ["早上喝咖啡。", "晚上喝茶。", "中午吃麵包。", "早上買牛奶。"], answerIndex: 0 },
  { id: "jl-032", level: "N5", category: "學校", japanese: "先生に質問しました。", kana: "せんせいに しつもんしました。", zh: "我問了老師問題。", question: "這句日文的意思是什麼？", options: ["我問了老師問題。", "老師回答了朋友。", "我在教室睡覺。", "學生寫了名字。"], answerIndex: 0 },
  ...
  { id: "jl-034", level: "N5", category: "餐廳", japanese: "この店はおいしいです。", kana: "この みせは おいしいです。", zh: "這家店很好吃。", question: "這句日文的意思是什麼？", options: ["這家店很好吃。", "那家店很遠。", "這個房間很安靜。", "這道菜很辣。"], answerIndex: 0 },
  { id: "jl-035", level: "N5", category: "購物", japanese: "赤い靴を買いました。", kana: "あかい くつを かいました。", zh: "我買了紅色鞋子。", question: "這句日文的意思是什麼？", options: ["我買了紅色鞋子。", "我穿了白色襯衫。", "我賣了黑色包包。", "我正在找藍色帽子。"], answerIndex: 0 },
  { id: "jl-036", level: "N5", category: "時間", japanese: "授業は九時半に始まります。", kana: "じゅぎょうは くじはんに はじまります。", zh: "課九點半開始。", question: "這句日文的意思是什麼？", options: ["課九點半開始。", "課十點結束。", "會議八點半開始。", "學校今天休息。"], answerIndex: 0 },
  ...
  { id: "jl-038", level: "N5", category: "家庭", japanese: "弟は部屋にいます。", kana: "おとうとは へやに います。", zh: "弟弟在房間裡。", question: "這句日文的意思是什麼？", options: ["弟弟在房間裡。", "姐姐在廚房裡。", "爸爸在公司。", "媽媽去了車站。"], answerIndex: 0 },
  { id: "jl-039", level: "N5", category: "旅行", japanese: "写真をたくさん撮りました。", kana: "しゃしんを たくさん とりました。", zh: "拍了很多照片。", question: "這句日文的意思是什麼？", options: ["拍了很多照片。", "買了很多禮物。", "看了很多書。", "走了很長的路。"], answerIndex: 0 },
  { id: "jl-040", level: "N5", category: "工作", japanese: "今日は会社を休みます。", kana: "きょうは かいしゃを やすみます。", zh: "今天請假不上班。", question: "這句日文的意思是什麼？", options: ["今天請假不上班。", "今天去公司開會。", "明天開始工作。", "昨天工作很忙。"], answerIndex: 0 },
  ...
  { id: "jl-042", level: "N5", category: "便利商店", japanese: "お弁当を温めてください。", kana: "おべんとうを あたためてください。", zh: "請幫我加熱便當。", question: "這句日文的意思是什麼？", options: ["請幫我加熱便當。", "請幫我影印文件。", "請給我一個袋子。", "請找我零錢。"], answerIndex: 0 },
  { id: "jl-043", level: "N5", category: "電話 / 約定", japanese: "あとで電話します。", kana: "あとで でんわします。", zh: "我等一下打電話。", question: "這句日文的意思是什麼？", options: ["我等一下打電話。", "我現在寫信。", "我明天見朋友。", "我昨天收到電話。"], answerIndex: 0 },
  { id: "jl-044", level: "N5", category: "方向 / 地點", japanese: "銀行は郵便局の隣です。", kana: "ぎんこうは ゆうびんきょくの となりです。", zh: "銀行在郵局旁邊。", question: "這句日文的意思是什麼？", options: ["銀行在郵局旁邊。", "郵局在車站前面。", "銀行在學校後面。", "醫院在公園裡。"], answerIndex: 0 },
  ...
  { id: "jl-046", level: "N4", category: "日常生活", japanese: "シャワーを浴びてから寝ます。", kana: "シャワーを あびてから ねます。", zh: "洗完澡後睡覺。", question: "這句日文的意思是什麼？", options: ["洗完澡後睡覺。", "睡醒後洗澡。", "洗完衣服後出門。", "吃完飯後讀書。"], answerIndex: 0 },
  { id: "jl-047", level: "N5", category: "學校", japanese: "ノートを忘れました。", kana: "ノートを わすれました。", zh: "我忘了帶筆記本。", question: "這句日文的意思是什麼？", options: ["我忘了帶筆記本。", "我買了新鉛筆。", "我交了作業。", "我借了字典。"], answerIndex: 0 },
  { id: "jl-048", level: "N5", category: "交通", japanese: "電車が少し遅れています。", kana: "でんしゃが すこし おくれています。", zh: "電車有點誤點。", question: "這句日文的意思是什麼？", options: ["電車有點誤點。", "公車很快到了。", "電車非常空。", "車票有點貴。"], answerIndex: 0 },
  ...
  { id: "jl-050", level: "N5", category: "購物", japanese: "もう少し安い物はありますか。", kana: "もうすこし やすい ものは ありますか。", zh: "有再便宜一點的東西嗎？", question: "這句日文的意思是什麼？", options: ["有再便宜一點的東西嗎？", "有再大一點的房間嗎？", "可以用信用卡嗎？", "這個東西很貴嗎？"], answerIndex: 0 },
  { id: "jl-051", level: "N5", category: "時間", japanese: "日曜日に友だちと会います。", kana: "にちようびに ともだちと あいます。", zh: "星期日和朋友見面。", question: "這句日文的意思是什麼？", options: ["星期日和朋友見面。", "星期六和家人吃飯。", "星期一去學校。", "星期五看電影。"], answerIndex: 0 },
  { id: "jl-052", level: "N4", category: "天氣", japanese: "雨が降りそうです。", kana: "あめが ふりそうです。", zh: "看起來快要下雨了。", question: "這句日文的意思是什麼？", options: ["看起來快要下雨了。", "雨已經停了。", "天氣變得很冷。", "明天應該會放晴。"], answerIndex: 0 },
  ...
  { id: "jl-054", level: "N4", category: "旅行", japanese: "京都へ行ったことがあります。", kana: "きょうとへ いったことが あります。", zh: "我去過京都。", question: "這句日文的意思是什麼？", options: ["我去過京都。", "我想去東京。", "我住在大阪。", "我明天去奈良。"], answerIndex: 0 },
  { id: "jl-055", level: "N4", category: "工作", japanese: "明日までに資料を出さなければなりません。", kana: "あしたまでに しりょうを ださなければなりません。", zh: "必須在明天前交資料。", question: "這句日文的意思是什麼？", options: ["必須在明天前交資料。", "明天之前不用開會。", "今天要看完資料。", "資料已經交出去了。"], answerIndex: 0 },
  { id: "jl-056", level: "N5", category: "醫院 / 藥局", japanese: "この薬を飲んでください。", kana: "この くすりを のんでください。", zh: "請吃這個藥。", question: "這句日文的意思是什麼？", options: ["請吃這個藥。", "請量一下體溫。", "請在這裡等。", "請買這個藥。"], answerIndex: 0 },
  ...
  { id: "jl-058", level: "N4", category: "電話 / 約定", japanese: "六時に駅で会いましょう。", kana: "ろくじに えきで あいましょう。", zh: "六點在車站見面吧。", question: "這句日文的意思是什麼？", options: ["六點在車站見面吧。", "七點在學校上課吧。", "六點搭電車回家吧。", "明天在公園散步吧。"], answerIndex: 0 },
  { id: "jl-059", level: "N5", category: "方向 / 地點", japanese: "まっすぐ行ってください。", kana: "まっすぐ いってください。", zh: "請直走。", question: "這句日文的意思是什麼？", options: ["請直走。", "請右轉。", "請等一下。", "請坐下。"], answerIndex: 0 },
  { id: "jl-060", level: "N4", category: "請求 / 許可", japanese: "窓を開けてもいいですか。", kana: "まどを あけても いいですか。", zh: "可以打開窗戶嗎？", question: "這句日文的意思是什麼？", options: ["可以打開窗戶嗎？", "請關上門好嗎？", "可以借這本書嗎？", "請把窗戶擦乾淨。"], answerIndex: 0 },
  ...
  { id: "jl-062", level: "N4", category: "日常生活", japanese: "部屋を掃除してから、出かけます。", kana: "へやを そうじしてから、でかけます。", zh: "打掃房間後出門。", question: "這句日文的意思是什麼？", options: ["打掃房間後出門。", "回家後打掃房間。", "出門前洗衣服。", "打掃教室後回家。"], answerIndex: 0 },
  { id: "jl-063", level: "N5", category: "學校", japanese: "教室に学生がいます。", kana: "きょうしつに がくせいが います。", zh: "教室裡有學生。", question: "這句日文的意思是什麼？", options: ["教室裡有學生。", "圖書館裡有老師。", "學生在操場跑步。", "教室裡沒有桌子。"], answerIndex: 0 },
  { id: "jl-064", level: "N4", category: "學校", japanese: "明日、漢字のテストがあると思います。", kana: "あした、かんじの テストが あると おもいます。", zh: "我想明天有漢字考試。", question: "這句日文的意思是什麼？", options: ["我想明天有漢字考試。", "我覺得今天沒有課。", "明天要交日記。", "昨天有數學考試。"], answerIndex: 0 },
  ...
  { id: "jl-066", level: "N4", category: "交通", japanese: "電車よりバスのほうが安いです。", kana: "でんしゃより バスの ほうが やすいです。", zh: "公車比電車便宜。", question: "這句日文的意思是什麼？", options: ["公車比電車便宜。", "電車比公車快。", "計程車比公車貴。", "公車站比車站遠。"], answerIndex: 0 },
  { id: "jl-067", level: "N5", category: "餐廳", japanese: "メニューを見せてください。", kana: "メニューを みせてください。", zh: "請給我看菜單。", question: "這句日文的意思是什麼？", options: ["請給我看菜單。", "請給我水。", "請結帳。", "請幫我加熱。"], answerIndex: 0 },
  { id: "jl-068", level: "N4", category: "餐廳", japanese: "予約をしていないので、少し待ちます。", kana: "よやくを していないので、すこし まちます。", zh: "因為沒有預約，所以等一下。", question: "這句日文的意思是什麼？", options: ["因為沒有預約，所以等一下。", "因為已經吃飽，所以回家。", "因為菜很辣，所以喝水。", "因為店很近，所以走路去。"], answerIndex: 0 },
  ...
  { id: "jl-070", level: "N5", category: "購物", japanese: "カードで払ってもいいですか。", kana: "カードで はらっても いいですか。", zh: "可以用卡付款嗎？", question: "這句日文的意思是什麼？", options: ["可以用卡付款嗎？", "可以在這裡坐嗎？", "要用現金付款嗎？", "請給我收據。"], answerIndex: 0 },
  { id: "jl-071", level: "N5", category: "時間", japanese: "午後二時に来てください。", kana: "ごご にじに きてください。", zh: "請下午兩點來。", question: "這句日文的意思是什麼？", options: ["請下午兩點來。", "請早上九點走。", "我晚上七點回家。", "公車十點出發。"], answerIndex: 0 },
  { id: "jl-072", level: "N4", category: "時間", japanese: "宿題は今夜までにしなければなりません。", kana: "しゅくだいは こんやまでに しなければなりません。", zh: "作業必須在今晚前做完。", question: "這句日文的意思是什麼？", options: ["作業必須在今晚前做完。", "作業明天不用交。", "今晚想看電視。", "考試必須在早上開始。"], answerIndex: 0 },
  ...
  { id: "jl-074", level: "N4", category: "天氣", japanese: "寒いので、コートを着ます。", kana: "さむいので、コートを きます。", zh: "因為很冷，所以穿外套。", question: "這句日文的意思是什麼？", options: ["因為很冷，所以穿外套。", "因為很熱，所以開窗。", "因為下雨，所以帶傘。", "因為風大，所以回家。"], answerIndex: 0 },
  { id: "jl-075", level: "N5", category: "家庭", japanese: "父は新聞を読んでいます。", kana: "ちちは しんぶんを よんでいます。", zh: "爸爸正在看報紙。", question: "這句日文的意思是什麼？", options: ["爸爸正在看報紙。", "媽媽正在做晚餐。", "哥哥正在看電視。", "妹妹正在寫作業。"], answerIndex: 0 },
  { id: "jl-076", level: "N5", category: "家庭", japanese: "家族で晩ごはんを食べました。", kana: "かぞくで ばんごはんを たべました。", zh: "和家人吃了晚餐。", question: "這句日文的意思是什麼？", options: ["和家人吃了晚餐。", "和朋友看了電影。", "一個人去了公園。", "和同事喝了咖啡。"], answerIndex: 0 },
  ...
  { id: "jl-078", level: "N4", category: "旅行", japanese: "来年、日本へ旅行する予定です。", kana: "らいねん、にほんへ りょこうする よていです。", zh: "明年預定去日本旅行。", question: "這句日文的意思是什麼？", options: ["明年預定去日本旅行。", "去年去了日本留學。", "明天要去東京出差。", "今年不打算旅行。"], answerIndex: 0 },
  { id: "jl-079", level: "N5", category: "工作", japanese: "机の上に書類があります。", kana: "つくえの うえに しょるいが あります。", zh: "桌上有文件。", question: "這句日文的意思是什麼？", options: ["桌上有文件。", "椅子下有包包。", "書架上有雜誌。", "門口有客人。"], answerIndex: 0 },
  { id: "jl-080", level: "N4", category: "工作", japanese: "今日は早く帰るつもりです。", kana: "きょうは はやく かえる つもりです。", zh: "今天打算早點回去。", question: "這句日文的意思是什麼？", options: ["今天打算早點回去。", "明天想早點上班。", "今天必須加班。", "昨天很晚才回家。"], answerIndex: 0 },
  ...
  { id: "jl-082", level: "N4", category: "醫院 / 藥局", japanese: "熱があるので、薬局へ行きます。", kana: "ねつが あるので、やっきょくへ いきます。", zh: "因為發燒，所以去藥局。", question: "這句日文的意思是什麼？", options: ["因為發燒，所以去藥局。", "因為肚子餓，所以去餐廳。", "因為頭痛，所以回學校。", "因為很累，所以去銀行。"], answerIndex: 0 },
  { id: "jl-083", level: "N5", category: "便利商店", japanese: "コピーを一枚お願いします。", kana: "コピーを いちまい おねがいします。", zh: "請幫我影印一張。", question: "這句日文的意思是什麼？", options: ["請幫我影印一張。", "請給我一個便當。", "請加熱一杯咖啡。", "請找我一百日圓。"], answerIndex: 0 },
  { id: "jl-084", level: "N5", category: "便利商店", japanese: "袋は要りません。", kana: "ふくろは いりません。", zh: "我不需要袋子。", question: "這句日文的意思是什麼？", options: ["我不需要袋子。", "我想要筷子。", "請給我收據。", "袋子在哪裡？"], answerIndex: 0 },
  ...
  { id: "jl-086", level: "N4", category: "電話 / 約定", japanese: "用事があるので、約束の時間を変えたいです。", kana: "ようじが あるので、やくそくの じかんを かえたいです。", zh: "因為有事，想改約定時間。", question: "這句日文的意思是什麼？", options: ["因為有事，想改約定時間。", "因為沒空，想取消旅行。", "因為遲到，想搭計程車。", "因為很忙，想早點睡。"], answerIndex: 0 },
  { id: "jl-087", level: "N5", category: "方向 / 地點", japanese: "トイレは二階にあります。", kana: "トイレは にかいに あります。", zh: "廁所在二樓。", question: "這句日文的意思是什麼？", options: ["廁所在二樓。", "教室在一樓。", "電梯在右邊。", "出口在前面。"], answerIndex: 0 },
  { id: "jl-088", level: "N5", category: "方向 / 地點", japanese: "ここを右に曲がってください。", kana: "ここを みぎに まがってください。", zh: "請在這裡右轉。", question: "這句日文的意思是什麼？", options: ["請在這裡右轉。", "請在前面左轉。", "請直走到車站。", "請在那裡停車。"], answerIndex: 0 },
  ...
  { id: "jl-090", level: "N4", category: "請求 / 許可", japanese: "写真を撮ってもいいですか。", kana: "しゃしんを とっても いいですか。", zh: "可以拍照嗎？", question: "這句日文的意思是什麼？", options: ["可以拍照嗎？", "可以唱歌嗎？", "請幫我拍照。", "請不要拍照。"], answerIndex: 0 },
  { id: "jl-091", level: "N5", category: "郵局 / 銀行", japanese: "郵便局で切手を買います。", kana: "ゆうびんきょくで きってを かいます。", zh: "在郵局買郵票。", question: "這句日文的意思是什麼？", options: ["在郵局買郵票。", "在銀行換錢。", "在便利商店買信封。", "在車站買車票。"], answerIndex: 0 },
  { id: "jl-092", level: "N4", category: "郵局 / 銀行", japanese: "銀行でお金をおろすことができます。", kana: "ぎんこうで おかねを おろすことが できます。", zh: "可以在銀行提款。", question: "這句日文的意思是什麼？", options: ["可以在銀行提款。", "可以在郵局寄信。", "可以在店裡刷卡。", "可以在車站買票。"], answerIndex: 0 },
  ...
  { id: "jl-094", level: "N5", category: "圖書館", japanese: "この本は来週返します。", kana: "この ほんは らいしゅう かえします。", zh: "這本書下週歸還。", question: "這句日文的意思是什麼？", options: ["這本書下週歸還。", "那本書今天購買。", "這本書昨天借出。", "雜誌明天送到。"], answerIndex: 0 },
  { id: "jl-095", level: "N5", category: "飯店 / 住宿", japanese: "チェックインをお願いします。", kana: "チェックインを おねがいします。", zh: "我要辦理入住。", question: "這句日文的意思是什麼？", options: ["我要辦理入住。", "我要退房。", "請打掃房間。", "請叫計程車。"], answerIndex: 0 },
  { id: "jl-096", level: "N4", category: "飯店 / 住宿", japanese: "部屋が寒いので、毛布をください。", kana: "へやが さむいので、もうふを ください。", zh: "因為房間很冷，請給我毛毯。", question: "這句日文的意思是什麼？", options: ["因為房間很冷，請給我毛毯。", "因為房間很熱，請開窗。", "因為房間很吵，想換房間。", "因為床很大，請拍照。"], answerIndex: 0 },
  ...
  { id: "jl-098", level: "N4", category: "休假 / 週末", japanese: "日曜日は映画を見に行くつもりです。", kana: "にちようびは えいがを みに いく つもりです。", zh: "星期日打算去看電影。", question: "這句日文的意思是什麼？", options: ["星期日打算去看電影。", "星期六預定去旅行。", "明天必須去上班。", "週末想在家讀書。"], answerIndex: 0 },
  { id: "jl-099", level: "N5", category: "身體狀況", japanese: "今日は少し疲れています。", kana: "きょうは すこし つかれています。", zh: "今天有點累。", question: "這句日文的意思是什麼？", options: ["今天有點累。", "今天很開心。", "昨天有點冷。", "明天很忙。"], answerIndex: 0 },
  { id: "jl-100", level: "N4", category: "身體狀況", japanese: "早く寝たほうがいいです。", kana: "はやく ねた ほうが いいです。", zh: "最好早點睡。", question: "這句日文的意思是什麼？", options: ["最好早點睡。", "可以晚點起床。", "必須早點出門。", "想慢慢吃飯。"], answerIndex: 0 },
];
