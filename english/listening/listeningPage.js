...
const geptPictureListeningItems = [
  { id: "gept_picture_001", type: "geptPicture", audioText: "The dog is under the chair.", answerId: "picture_dog_under_chair", options: [{ id: "picture_dog_under_chair", label: "🐶⬇️🪑", alt: "dog under chair" }, { id: "picture_cat_on_chair", label: "🐱⬆️🪑", alt: "cat on chair" }, { id: "picture_boy_reading", label: "👦📖", alt: "boy reading" }, { id: "picture_girl_running", label: "👧🏃", alt: "girl running" }], level: "GEPT Elementary" },
  ...
  { id: "gept_picture_004", type: "geptPicture", audioText: "There are three apples on the table.", answerId: "picture_three_apples_table", options: [{ id: "picture_three_apples_table", label: "🍎🍎🍎🟫", alt: "three apples on table" }, { id: "picture_one_banana", label: "🍌", alt: "one banana" }, { id: "picture_two_books", label: "📚📚", alt: "two books" }, { id: "picture_milk_cup", label: "🥛", alt: "milk" }], level: "GEPT Elementary" },
  { id: "gept_picture_005", type: "geptPicture", audioText: "The cat is sleeping on the sofa.", answerId: "picture_cat_sofa", options: [{ id: "picture_cat_sofa", label: "🐱💤🛋️", alt: "cat sleeping on sofa" }, { id: "picture_dog_chair", label: "🐶🪑", alt: "dog by chair" }, { id: "picture_bird_tree", label: "🐦🌳", alt: "bird in tree" }, { id: "picture_fish_bowl", label: "🐟", alt: "fish" }], level: "GEPT Elementary" },
