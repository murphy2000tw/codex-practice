...
['sc-n5-021','母は台所でお茶を飲んでいます。'],['sc-n5-022','弟は毎晩九時に寝ます。'],['sc-n5-023','わたしはスーパーでパンを二つ買いました。'],['sc-n5-024','このかばんは軽くてとても使いやすいです。'],['sc-n5-025','駅の前に大きいバスが来ました。'],['sc-n5-026','日曜日は家で音楽を聞きます。'],['sc-n5-027','先生は黒板に漢字を書いています。'],['sc-n5-028','きのう友だちと公園でサッカーをしました。'],['sc-n5-029','あした雨が降りますから出かけません。'],['sc-n5-030','妹は新しい靴をほしがっています。'],
['sc-n4-021','妹は熱があるらしいです。'],['sc-n4-022','この箱は重すぎて一人で持てません。'],['sc-n4-023','このペンは字が書きやすいです。'],['sc-n4-024','この説明は字が小さくて読みにくいです。'],['sc-n4-025','子どもが急に泣き始めました。'],['sc-n4-026','レポートを全部書き終わりました。'],['sc-n4-027','大切な書類を電車に忘れてしまいました。'],['sc-n4-028','この店ではカードで払うことができます。'],['sc-n4-029','健康のために毎日野菜を食べるようにしています。'],['sc-n4-030','地震の場合はすぐに外へ出てください。']]);
